  ...
  return (
    <section className="relative py-20 md:py-28 lg:py-36 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-24 -right-1/4 w-1/2 h-1/2 bg-gradient-radial from-brand-400/30 to-transparent opacity-70 blur-3xl"></div>
        <div className="absolute -bottom-32 -left-1/4 w-1/2 h-1/2 bg-gradient-radial from-blue-400/20 to-transparent opacity-70 blur-3xl"></div>
      </div>
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="heading-xl mb-6 reveal-element">
              ...
              <span className="relative z-10 px-2 mx-1">
                AI
                <svg className="absolute bottom-1 -z-10 w-full h-3 left-0" viewBox="0 0 200 15" xmlns="http://www.w3.org/2000/svg">
